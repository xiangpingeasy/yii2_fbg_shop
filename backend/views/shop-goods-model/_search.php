...
/* @var $model app\models\ShopGoodsModelSearch */
/* @var $form yii\widgets\ActiveForm */
?>

<div class="shop-goods-model-search"  style="margin-bottom: 10px;">
    ...
    <?= $form->field($model, 'goods_model_id') ?>

    <?= $form->field($model, 'goods_model_name') ?>
